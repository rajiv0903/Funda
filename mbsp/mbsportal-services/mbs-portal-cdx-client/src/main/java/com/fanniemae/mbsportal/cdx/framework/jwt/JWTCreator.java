...
import com.fanniemae.mbsportal.cdx.framework.jwt.exceptions.JWTCreationException;
import com.fanniemae.mbsportal.cdx.framework.jwt.exceptions.SignatureGenerationException;
import com.fanniemae.mbsportal.cdx.framework.jwt.impl.ClaimsHolder;
import com.fanniemae.mbsportal.cdx.framework.jwt.impl.PayloadSerializer;
import com.fanniemae.mbsportal.cdx.framework.jwt.impl.PublicClaims;
...
public final class JWTCreator {
    ...
    private JWTCreator(Map<String, Object> headerClaims, Map<String, Object> payloadClaims) throws JWTCreationException {
        this.algorithm = null;
        try {
            ObjectMapper mapper = new ObjectMapper();
            SimpleModule module = new SimpleModule();
    ...
    public static class Builder {
        ...
        /**
         * Creates a new JWT and signs is with the no algorithm
         *
         *
         * @return a new JWT token
         * @throws IllegalArgumentException if the provided algorithm is null.
         * @throws JWTCreationException     if the claims could not be converted to a valid JSON or there was a problem with the signing key.
         */
        public String signNOAlgorithm() throws IllegalArgumentException, JWTCreationException {

            headerClaims.put(PublicClaims.ALGORITHM, "NONE");
            headerClaims.put(PublicClaims.TYPE, "JWT");

            return new JWTCreator(headerClaims, payloadClaims).sign();
        }
    ...
    private String sign() throws SignatureGenerationException {
        ...
        {
            return String.format("%s.%s", content);
        }
    }
}
