 ...
 */
@Component
public class ExceptionPOTransformer<T extends TransformationObject> extends BaseTransformer<T> {
	...
	// private Logger LOGGER;
         ...
         */
	private static final Logger LOGGER = LoggerFactory.getLogger(ExceptionPOTransformer.class);
