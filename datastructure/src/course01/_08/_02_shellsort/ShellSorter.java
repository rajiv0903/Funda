package course01._08._02_shellsort;
...
public class ShellSorter {
	...
	public static void main(String[] args) {
		...
		int[] toPrimitive = ShellSorter.toPrimitive(data2);
		long start2 = System.currentTimeMillis();
		new InsertionSorter().sort(toPrimitive); // InsertionSort was implemented earlier, calling it to compare with Shell Sort
