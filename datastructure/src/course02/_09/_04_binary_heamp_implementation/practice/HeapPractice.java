package course02._09._04_binary_heamp_implementation.practice;

import java.lang.reflect.Array;

public abstract class HeapPractice<T extends Comparable<T>> 
{
	private static int MAX_SIZE = 40;
	private T[] array;
	private int count = 0;
	
	public HeapPractice(Class<T> clazz) {
		this(clazz, MAX_SIZE);
    }

    public HeapPractice(Class<T> clazz, int size) 
    {
