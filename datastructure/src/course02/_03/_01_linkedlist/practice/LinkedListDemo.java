...
public class LinkedListDemo {
	...
	{
		LinkedListPractice<Integer> n = new LinkedListPractice<Integer>();
		n.addNode(3);
		n.addNode(4);
		n.addNode(5);
		n.addNode(10);
		...
		LinkedListPractice<Integer> n1 = new LinkedListPractice<Integer>();
		n1.addNode(500);
		n1.addNode(600);
		n1.addNode(700);
		...
		LinkedListPractice<Integer> mergesort = n.sortedMergeList(n1);
		System.out.println("Printing all nodes through printnode function after mergesorted function");
		mergesort.printNodes();

		List<NodePractice<Integer>> frontBackSplit = n.frontBackSplit();
	...
	static void printNode(NodePractice head) {
		NodePractice curr = null;
		curr = head;
		int i = 1;
		while (curr != null) {
			System.out.println("this is the Node number " + i
					+ ", the value it stores is " + curr.toString());
			curr = curr.getNext();
			i++;
		}
