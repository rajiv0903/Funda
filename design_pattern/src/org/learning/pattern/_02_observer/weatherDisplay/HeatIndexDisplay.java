...
import org.learning.pattern._02_observer.weatherSubject.WeatherSubjectDataInterface;

public class HeatIndexDisplay implements WeatherObserver, WeatherDisplayElement {
	
	float heatIndex = 0.0f;
	private WeatherSubjectDataInterface weatherSubjectData;

	public HeatIndexDisplay(WeatherSubjectDataInterface weatherSubjectData) {
